...
/// updatedAt : "2025-04-14T17:43:05.827Z"
/// __v : 14
/// totalCartPrice : 3874

class UpdateCartItemDataEntity {
  UpdateCartItemDataEntity({
      this.id, 
      this.cartOwner, 
      this.products, 
      this.createdAt, 
  ...
  String? id;
  String? cartOwner;
  List<UpdateCartItemProductsEntity>? products;
  String? createdAt;
  String? updatedAt;
  int? v;
  int? totalCartPrice;
...
class UpdateCartItemProductsEntity {
  UpdateCartItemProductsEntity({
      this.count, 
      this.id, 
      this.product, 
      this.price,});
  ...
  int? count;
  String? id;
  UpdateCartItemProductesEntity? product;
  int? price;
...
class UpdateCartItemProductesEntity {
  UpdateCartItemProductesEntity({
      this.subcategory, 
      this.id, 
      this.title, 
      this.quantity, 
  ...
  List<UpdateCartItemSubcategoryEntity>? subcategory;
  String? id;
  String? title;
  int? quantity;
  String? imageCover;
  UpdateCartItemCategoryEntity? category;
  UpdateCartItemBrandEntity? brand;
...
class UpdateCartItemBrandEntity {
  UpdateCartItemBrandEntity({
      this.id, 
      this.name, 
      this.slug, 
      this.image,});
...
class UpdateCartItemCategoryEntity {
  UpdateCartItemCategoryEntity({
      this.id, 
      this.name, 
      this.slug, 
      this.image,});
...
class UpdateCartItemSubcategoryEntity {
  UpdateCartItemSubcategoryEntity({
      this.id, 
      this.name, 
      this.slug, 
      this.category,});
