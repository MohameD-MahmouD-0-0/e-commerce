...
class BrandesResponseDto {
  ...
  BrandesResponseDto.fromJson(dynamic json) {
  ...
  BrandesResponseEntity toBrandesEntity() {
    return BrandesResponseEntity(
        results: results,
        data: data!.map((dataDto) => DataBrandesEntity(
            id: dataDto.id,
            updatedAt: dataDto.updatedAt,
            slug: dataDto.slug,
